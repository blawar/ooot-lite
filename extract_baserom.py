...
def ROM_FILE_NAME_mq():
    return 'baserom.mq.z64'

def ROM_FILE_NAME_eu():
    return 'baserom.eu.z64'

def FILE_TABLE_OFFSET_mq():
    return 0x12F70

def FILE_TABLE_OFFSET_eu():
    return 0x7950
...
def main():
    ...
    # too lazy to rewrite
    global rom_file_name
    global file_names
    global file_table_offset

    if args.debug:
        rom_file_name = ROM_FILE_NAME_mq()
        file_names = FILE_NAMES_mq()
        file_table_offset = FILE_TABLE_OFFSET_mq()
    if args.retail:
        rom_file_name = ROM_FILE_NAME_eu()
        file_names = FILE_NAMES_eu()
        file_table_offset = FILE_TABLE_OFFSET_eu()
