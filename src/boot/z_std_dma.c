...
s32 DmaMgr_SendRequestImpl(DmaRequest* req, void* ram, const void* vrom, uintptr_t size, u32 unk, OSMesgQueue* queue,
                           OSMesg msg) {
...
s32 DmaMgr_SendRequest2(DmaRequest* req, void* ram, const void* vrom, uintptr_t size, u32 unk5, OSMesgQueue* queue,
                        OSMesg msg,
